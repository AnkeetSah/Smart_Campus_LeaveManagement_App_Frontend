  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-20 px-5 md:pt-4 pt-2 flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:px-20">
                    ...
                    >
                      {item.speaker === "agent" && (
                        <div className="mr-3 md:mr-4 flex-shrink-0">
                          <img
                            src="/ai-assistant-avatar-small.png"
                            alt="AI Assistant Avatar"
        ...
        {/* Call Controls */}
        <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 flex justify-center items-center sticky bottom-0 z-10 border-t-4 border-blue-400">
          {!isActive ? (
            <button
