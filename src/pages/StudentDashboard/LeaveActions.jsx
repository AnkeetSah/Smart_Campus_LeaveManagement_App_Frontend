        ...
        >
          ...
          <div className="relative z-10">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={card.action}
              className={`w-full cursor-pointer py-3 rounded-xl text-white bg-gradient-to-r ${card.gradient} hover:${card.hoverGradient} dark:${card.darkGradient} dark:hover:${card.darkHoverGradient} font-semibold transition-all duration-300 flex items-center justify-center space-x-2 shadow-md dark:shadow-lg`}
            >
