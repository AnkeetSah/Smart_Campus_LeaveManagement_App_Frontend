                      ...
                      {selectedTab === "pending" ? (
                        <div className="flex gap-2">
                          <motion.button
                            ...
                            className="px-4 py-2 cursor-pointer bg-green-600 dark:bg-green-700 text-white text-sm font-medium rounded-lg hover:bg-green-700 dark:hover:bg-green-800 flex items-center gap-2"
                          >
                            <FaCheck /> Approve
                          </motion.button>
                          <motion.button
                            ...
                            className="px-4 py-2 cursor-pointer bg-red-600 dark:bg-red-700 text-white text-sm font-medium rounded-lg hover:bg-red-700 dark:hover:bg-red-800 flex items-center gap-2"
                          >
                            <FaTimes /> Reject
                          </motion.button>
                          <button
        ...
        <div className="fixed inset-0 bg-black/40 dark:bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 transition-all duration-300 ease-in-out">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 w-full max-w-lg space-y-5 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
            ...
            <textarea
              ...
              rows={5}
              className={`w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-white p-3 text-sm focus:outline-none focus:ring-2 ${
