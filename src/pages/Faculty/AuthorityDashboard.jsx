...
{/* {role && role === "warden" && (
  <motion.div
    ...
    className="mb-6 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 dark:from-gray-800/80 dark:to-gray-900/80 backdrop-blur-sm border border-white/30 dark:border-gray-700/50 rounded-xl shadow-md p-4"
  >
    <div className="flex items-center justify-between mb-3">
      ...
      <span className="px-2 py-1 text-xs font-medium bg-indigo-100/50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-md">
        {user.hostel || "Hostel"}
      </span>
    </div>
    
    <div className="grid grid-cols-3 gap-3 mb-3">
      <div className="bg-white/50 dark:bg-gray-800/50 p-2 rounded-lg border border-white/30 dark:border-gray-700/50 flex items-center">
        <div className="rounded-full bg-blue-100 dark:bg-blue-900 p-2 mr-2">
          <svg className="w-3 h-3 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
        </div>
        <div>
          <p className="text-sm font-bold text-gray-800 dark:text-white">450</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">Total</p>
        </div>
      </div>
      
      <div className="bg-white/50 dark:bg-gray-800/50 p-2 rounded-lg border border-white/30 dark:border-gray-700/50 flex items-center">
        <div className="rounded-full bg-green-100 dark:bg-green-900 p-2 mr-2">
          <svg className="w-3 h-3 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
          </svg>
        </div>
        <div>
          <p className="text-sm font-bold text-gray-800 dark:text-white">300</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">Present</p>
        </div>
      </div>
      
      <div className="bg-white/50 dark:bg-gray-800/50 p-2 rounded-lg border border-white/30 dark:border-gray-700/50 flex items-center">
        <div className="rounded-full bg-amber-100 dark:bg-amber-900 p-2 mr-2">
        ...
        <div>
          <p className="text-sm font-bold text-gray-800 dark:text-white">45</p>
    ...
    <motion.button 
      ...
      whileTap={{ scale: 0.98 }}
      className="w-full bg-indigo-600/90 hover:bg-indigo-700 text-white py-1.5 px-3 rounded-md text-sm font-medium flex items-center justify-center transition-colors"
    >
      ...
      Student Leave Details
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm border border-white/30 dark:border-gray-700/50 rounded-2xl shadow-lg dark:shadow-gray-900/30 p-6 mb-8 trans</div>ition-colors duration-300"
        >
